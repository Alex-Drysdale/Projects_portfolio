...
# titanic_disaster documentation build
...
from titanic_disaster import __version__ as release

# -- Project information -----------------------------------------------------

project = "titanic_disaster"
author = "Kedro"
...
latex_documents = [
    (
        ...
        "titanic_disaster Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "titanic_disaster",
        "Project titanic_disaster codebase.",
        "Data-Science",
    )
]
